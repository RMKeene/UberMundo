...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "ShareSteam", meta = (ToolTip = "Is there data to get? Returns 0 if no data, else the number of bytes available."))
